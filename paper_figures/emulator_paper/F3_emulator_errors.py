...
if __name__ == "__main__":
    ...
    ds_colors = cmap(np.linspace(0.01, 0.99, 5))
    ...
    _ = ax[-1].set_xticks(
        current_labels,
        s_values,  # [all_s[int(c)] for c in current_labels]
    )
    ...
    plt.savefig(
        f"figures/png/F2_emulator_errors_frac.png", dpi=600, bbox_inches="tight"
    )
    plt.savefig(f"figures/pdf/F2_emulator_errors_frac.pdf", bbox_inches="tight")
    ...
    plt.savefig(
        f"figures/png/F2_emulators_errors_std.png", dpi=600, bbox_inches="tight"
    )
    plt.savefig(f"figures/pdf/F2_emulators_errors_std.pdf", bbox_inches="tight")
