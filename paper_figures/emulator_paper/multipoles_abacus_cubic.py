...
args.add_argument(
    "--path_to_models", type=str, default="../../trained_models/enrique/best/"
)
...
for statistic in args.statistic:
    for ell in args.ell:
        ...
        fig, ax = plt.subplots(
            2, 1, figsize=(4.5, 4.5), sharex=True, gridspec_kw={"height_ratios": [4, 1]}
        )
        colors = [
            "#4477AA",
            "#EE6677",
        ...
        if ell == 0:
            multipole = "monopole"
            ax[0].legend(
                fontsize=15, handlelength=1.0, handletextpad=0.5, loc="lower right"
            )
        elif ell == 2:
