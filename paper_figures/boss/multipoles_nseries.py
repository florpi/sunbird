"""
Figure 10: Monopole from Nseries mocks and CMASS
"""
import numpy as np
...
args.add_argument('--statistic', type=str, nargs="*", default=['tpcf'])
...
for statistic in args.statistic:
    for ell in args.ell:
        ...
        chain_handle = f'nseries_cutsky_ph0_density_split_cross_density_split_auto_tpcf_mae_patchycov_vol1_smin0.70_smax150.00_m02_q0134_base_bbn'
        ...
        plt.savefig(f'fig/pdf/multipoles_nseries_cutsky_{statistic}_ell{ell}.pdf')