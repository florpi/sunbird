...
def get_emulator_predictions(statistics, parameters, select_filters, slice_filters, loss='mae',):
    emulator = Bundle(
...
if __name__ == '__main__':
    ...
    emulated_corrs = get_emulator_predictions(
        statistics=statistics,
    ...
    plt.savefig(f"figures/png/Figure1_abs_errors_frac_{dataset}.png", dpi=600, bbox_inches="tight")
    plt.savefig(f"figures/pdf/Figure1_abs_errors_frac_{dataset}.pdf", bbox_inches="tight")
    ...
    plt.savefig(f"figures/png/Figure1_abs_errors_std_{dataset}.png", dpi=600, bbox_inches="tight")
    plt.savefig(f"figures/pdf/Figure1_abs_errors_std_{dataset}.pdf", bbox_inches="tight")
